  ...
  return (
    <div className={s.itemContainer}>
        ...
        <div className={s.barsWrapper}>
           ...
           <VerticalProgressBar width={"40%"} data={[{value:50, color:"#FFF",backColor:"#FF6347",id:1},{value:350, color:"#FFF",backColor:"#77CB10",id:2},{value:50, color:"#FFF",backColor:"#FF8C00", id:3}]}/>
        </div>
    </div>
  )
}
